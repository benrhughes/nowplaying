...
/// </summary>
public record MediaResponse(string id, string? type = null, string? url = null, string? preview_url = null);

/// <summary>
/// Tag object in a status.
/// </summary>
/// <param name="name">The tag name.</param>
public record TagResponse(string name);

/// <summary>
/// Response for status post.
/// </summary>
public record StatusMastodonResponse(
    string id,
    string? url = null,
    string? content = null,
    [property: System.Text.Json.Serialization.JsonPropertyName("media_attachments")] List<MediaResponse>? MediaAttachments = null,
    [property: System.Text.Json.Serialization.JsonPropertyName("created_at")] DateTimeOffset? CreatedAt = null,
